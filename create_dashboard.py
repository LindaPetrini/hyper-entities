        ...
        <div class="modal-content" style="max-width: 900px; height: 80vh; display: flex; flex-direction: column; overflow: hidden;">
            ...
            <div style="flex: 1; overflow-y: scroll; min-height: 0; padding-right: 10px; margin-top: 15px;">
                <div id="method-v30" class="method-content active">
                    <h3 style="color: #a78bfa; margin-bottom: 15px;">What is a Hyper-Entity?</h3>
                    <div style="background: #1a1f3a; padding: 15px; border-radius: 8px; margin-bottom: 20px; border-left: 3px solid #60a5fa;">
                        <p style="font-style: italic; color: #e0e6f0;">A coherent, future-instantiated system that does not yet exist, but is treated as if it will; whose realization would create a new stable action space for humanity; and which already reorganizes coordination, investment, and narrative around its anticipated existence.</p>
                    </div>

                    <h4 style="color: #60a5fa; margin: 20px 0 10px;">Key Characteristics</h4>
                    <ul style="color: #94a3b8; margin-left: 20px; line-height: 1.8;">
                        <li><strong style="color: #e0e6f0;">Non-existent but treated as real</strong> - The system doesn't exist yet, but people act as if it will</li>
                        <li><strong style="color: #e0e6f0;">Creates new action spaces</strong> - Would enable fundamentally new things humans can do</li>
                        <li><strong style="color: #e0e6f0;">Pre-real effects</strong> - Already reorganizing coordination, investment, and narrative now</li>
                    </ul>

                    <h4 style="color: #60a5fa; margin: 25px 0 10px;">Stage 1: Initial Qualification Scoring</h4>
                    <p style="color: #94a3b8; margin-bottom: 10px;">Score each candidate on 9 axes (0-3 per axis). Maximum: 27 points. Threshold: ≥18 to qualify.</p>
                    <div style="overflow-x: auto;">
                        <table style="width: 100%; border-collapse: collapse; font-size: 12px; margin-bottom: 15px;">
                            <thead>
                                <tr style="background: #1e293b;">
                                    <th style="padding: 8px; text-align: left; border: 1px solid #3a4f7a; color: #60a5fa;">Axis</th>
                                    <th style="padding: 8px; text-align: center; border: 1px solid #3a4f7a; color: #94a3b8;">0</th>
                                    <th style="padding: 8px; text-align: center; border: 1px solid #3a4f7a; color: #94a3b8;">1</th>
                                    <th style="padding: 8px; text-align: center; border: 1px solid #3a4f7a; color: #94a3b8;">2</th>
                                    <th style="padding: 8px; text-align: center; border: 1px solid #3a4f7a; color: #94a3b8;">3</th>
                                </tr>
                            </thead>
                            <tbody style="color: #e0e6f0;">
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Non-existence</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Deployed</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Prototype</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Partial demos</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">No instantiation</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Plausibility</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Fantasy</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Hand-wavy</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Credible theory</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Active scientific path</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Design specificity</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Vague</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Metaphor</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Coarse arch.</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Detailed model</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>New action space</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Incremental</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Narrow new</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Broad new cap.</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Entirely new verb</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Roadmap clarity</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">None</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Wishful</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Research agenda</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Multi-stage roadmap</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Coordination gravity</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Solo</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Small niche</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Multiple orgs</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Global coordination</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Resource pull</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Trivial</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Some grants</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Serious capital</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Massive capital</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Narrative centrality</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Ignored</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Peripheral</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Often referenced</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Justifies actions</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Pre-real effects</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">None</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Speculation</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Market/policy</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Institutions reorganize</td></tr>
                            </tbody>
                        </table>
                    </div>

                    <h4 style="color: #60a5fa; margin: 25px 0 10px;">Historical Examples</h4>
                    <ul style="color: #94a3b8; margin-left: 20px; line-height: 1.8;">
                        <li><strong style="color: #e0e6f0;">The Internet (pre-1990s)</strong> - Reorganized telecoms R&D and policy before widespread deployment</li>
                        <li><strong style="color: #e0e6f0;">Space Exploration (1950s-60s)</strong> - Organized national budgets and narratives before any moon landings</li>
                        <li><strong style="color: #e0e6f0;">AGI (current)</strong> - Reorganizes AI research and tech strategy despite not existing yet</li>
                    </ul>
                </div>
                ...
                <div id="method-v31" class="method-content">
                    ...
                    <div style="overflow-x: auto;">
                        <table style="width: 100%; border-collapse: collapse; font-size: 12px; margin-bottom: 20px;">
                            <thead>
                                <tr style="background: #1e293b;">
                                    <th style="padding: 8px; text-align: left; border: 1px solid #3a4f7a; color: #60a5fa;">Dimension</th>
                            ...
                            <tbody style="color: #e0e6f0;">
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Capability Discontinuity</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">New powers unlocked</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Incremental</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Phase change</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Cross-Domain Reach</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Sectors touched</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Single domain</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Many domains</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Scalability</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Speed of global spread</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Local/slow</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Global/fast</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Autonomy</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Human control needed</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Fully manual</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Largely autonomous</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Composability</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Embeddability</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Standalone</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Universal substrate</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Feedback Intensity</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Self-reinforcing loops</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Weak</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Explosive</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Irreversibility</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Rollback difficulty</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Easy</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Impossible</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Power Concentration</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Centralizes leverage</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Dispersed</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Concentrated</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Externality Magnitude</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Size of spillovers</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Contained</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Civilizational</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Misuse Asymmetry</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Harm vs benefit ratio</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Symmetric</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Offense-dominant</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Governance Lag</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Gap vs institutions</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Aligned</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Wildly outpaced</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Narrative Lock-In</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Enforced story</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Optional</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Totalizing</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Path Dependency</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Futures foreclosed</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Minimal</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Many locked</td></tr>
                                <tr><td style="padding: 6px; border: 1px solid #3a4f7a;"><strong>Human Agency Impact</strong></td><td style="padding: 6px; border: 1px solid #3a4f7a;">Effect on choice</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Expands</td><td style="padding: 6px; border: 1px solid #3a4f7a; text-align: center;">Compresses</td></tr>
                            </tbody>
                        </table>
                    </div>

                    <div style="background: #1a1f3a; padding: 15px; border-radius: 8px; border-left: 3px solid #f59e0b;">
                        <p style="color: #f59e0b; font-weight: 600; margin-bottom: 8px;">Note on Interpretation</p>
                        <p style="color: #94a3b8;">Higher scores indicate greater impact/risk/priority - but are not necessarily "better." Some dimensions (e.g., Misuse Asymmetry, Human Agency Impact) indicate potential dangers at high scores.</p>
                    </div>

                    <h4 style="color: #60a5fa; margin: 25px 0 10px;">Consolidated Scoring (Dashboard View)</h4>
                    <p style="color: #94a3b8; margin-bottom: 10px;">For easier comparison, scores are grouped into 3 categories:</p>
                    <ul style="color: #94a3b8; margin-left: 20px; line-height: 1.8;">
