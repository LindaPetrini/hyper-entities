...
2. **Genuinely transformative** — would enable fundamentally new human capabilities, not just improve on existing ones.
3. **Already reshaping the present** — crucially, the mere *expectation* of its existence is already driving how people invest, coordinate, and talk about the future. A hyper-entity has causal force before it exists.
