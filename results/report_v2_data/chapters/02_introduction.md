...
Over 300 candidate hyper-entities were extracted from 108 documents from the [Existential Hope](https://existentialhope.com) community—65 podcast transcripts, 40 world gallery scenarios, AI pathways essays including Vitalik Buterin's [d/acc framework](https://vitalik.eth.limo/general/2023/11/27/techno_optimism.html), and one hackathon report. Each was scored on hyper-entity qualification, technology impact, and alignment with d/acc values (technologies that distribute power rather than concentrate it, strengthen defense over offense, and enable broad cooperation). Two researchers reviewed the results independently and agreed on 39 entities.
