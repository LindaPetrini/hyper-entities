...
Key Findings opens with a scatter plot of all 39 entities by d/acc alignment and technology impact, plus a shortlist of seven that stand out on both dimensions. The thematic chapters that follow go deeper on each cluster and work as standalone reads.
