...
Over 300 candidate hyper-entities were extracted from 109 source documents (~490,000 words) from the [Existential Hope](https://existentialhope.com) community:
...
- **41 world gallery submissions** from [Existential Hope](https://existentialhope.com/world-gallery) — written scenarios of positive long-range futures contributed by researchers and practitioners
- **3 reports**, including the Existential Hope Hackathon report and Vitalik Buterin's [d/acc framework](https://vitalik.eth.limo/general/2023/11/27/techno_optimism.html) essays

Each candidate was scored on hyper-entity qualification, technology impact, and alignment with d/acc values (technologies that distribute power rather than concentrate it, strengthen defense over offense, and enable broad cooperation). Two researchers reviewed the results independently and agreed on 39 entities.
