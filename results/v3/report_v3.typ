...
The #link("https://montrealethics.ai/")[Montreal AI Ethics Institute] has developed research and design frameworks for fiduciary AI systems. #link("https://innovation.consumerreports.org/")[Consumer Reports Innovation] is exploring personal AI agents operating under fiduciary duty principles. The #link("https://alignment.anthropic.com/")[Alignment Research Center] contributes relevant user-centric alignment research. No dedicated external funding has been documented. _TRL 3_ — published design methodologies and legal frameworks exist, but no commercial deployment has occurred.
...
_Who's building toward this._ The #link("https://c2pa.org/")[Coalition for Content Provenance and Authenticity (C2PA)] released its open technical standard in 2022, with adoption now spanning camera makers, news outlets, and platforms. The #link("https://contentauthenticity.org/")[Content Authenticity Initiative (CAI)] develops open-source tooling within that coalition. X's Community Notes operates crowdsourced fact-checking at scale with 133,000+ contributors. Numbers Protocol integrates C2PA provenance data with blockchain for immutable asset tracking. No dedicated funding for a unified epistemic stack has been identified. TRL: 4—components exist in isolation; end-to-end integration from raw sensor data through inference to published claims with per-node trust scoring remains unbuilt.
