...
_Links._
- #link("https://flower.ai")[Flower (adap gmbh)] — Building federated learning framework for decentralized AI training
- #link("https://www.openmined.org")[OpenMined] — Developing PySyft library for privacy-preserving federated learning
- #link("https://www.gida-global.org")[Global Indigenous Data Alliance (GIDA)] — Stewarding CARE Principles for Indigenous Data Governance
- #link("https://localcontexts.org")[Local Contexts] — Supporting Indigenous data sovereignty and cultural heritage protection
- #link("https://bittensor.com")[Bittensor] — Building decentralized AI infrastructure with community-governed token incentives
- #link("https://arxiv.org/abs/2007.14390")[FLOWER: A Friendly Federated Learning Framework] (2020)
- #link("https://datascience.codata.org/articles/dsj-2020-043")[The CARE Principles for Indigenous Data Governance] (2019)
- #link("https://www.unesco.org/ethics-ai/en/articles/new-report-and-guidelines-indigenous-data-sovereignty-artificial-intelligence-developments")[Indigenous People-Centered Artificial Intelligence: Perspectives from Latin America and the Caribbean] (2024)
- Source: #link("https://worlds.existentialhope.com/world/the-living-rights-network/")[the-living-rights-network]
...
_Who's building toward this._ Mozilla Foundation has committed \$2.7M (2023) for its Responsible Computing Challenge across Kenya, India, and the US, and \$1M (2025–2027) for its Democracy x AI Cohort. The African Union Commission is developing a Continental AI Strategy and Digital Education Strategy (2023–2028) through multi-stakeholder consultation. UNESCO is establishing AI ethics standards and competency frameworks for students and teachers. AIGN is developing operational AI governance frameworks for schools and universities with audit mechanisms. IDRC supports the EmpowerED initiative for responsible AI implementation in African education systems. The project sits at _TRL 3_—conceptual frameworks are mature, but no fully operational federated institution with formal elder council oversight exists at scale.

_d/acc alignment._ UALU scores highest on Democratic (5/5) and Defensive (5/5), reflecting its structural commitment to participatory oversight and harm mitigation through community-led auditing. Decentralization scores 4/5, grounded in the federated node architecture.


_Links._
- #link("https://aign.global/ai-governance-framework/global-ai-governance-framework/education-ai-governance-framework/")[AIGN (AI Governance Network)] — Developing operational AI governance framework for schools and universities with audit mechanisms and compliance tools
- #link("https://www.mozillafoundation.org/en/internet-health/trustworthy-artificial-intelligence/")[Mozilla Foundation] — Funding responsible AI governance initiatives and multi-stakeholder accountability mechanisms for AI systems
- #link("https://au.int/en/pressreleases/20240617/african-ministers-adopt-landmark-continental-artificial-intelligence-strategy")[African Union Commission] — Developing Continental AI Strategy and Digital Education Strategy (2023-2028) with multi-stakeholder consultation frameworks
- #link("https://en.unesco.org/")[UNESCO] — Establishing AI ethics standards, competency frameworks for students/teachers, and guidance for responsible AI in education
- #link("https://idrc-crdi.ca/en/research-in-action/commitment-action-advancing-use-ai-education-africa")[IDRC (International Development Research Centre)] — Supporting AI4D and EmpowerED initiatives for capacity-building and responsible AI implementation in African education systems
- #link("https://assets.mofoprod.net/network/documents/Mozilla-Trustworthy_AI.pdf")[Creating Trustworthy AI] (2020)
- #link("https://www.oecd.org/en/publications/oecd-digital-education-outlook-2023_c74f03de-en/full-report/multi-stakeholder-collaboration-and-co-creation-towards-responsible-application-of-ai-in-education_07fbbd0d.html")[Multi-stakeholder collaboration and co-creation: towards responsible application of AI in education] (2023)
- #link("https://arxiv.org/html/2509.06176v1")[AI Governance in Higher Education: A course design exploring regulatory, ethical and practical considerations] (2025)
- Source: #link("https://worlds.existentialhope.com/world/the-learning-uncommons-of-2035/")[the-learning-uncommons-of-2035]
...
_Who's building toward this._ _RISC Zero_ provides the zero-knowledge virtual machine for proof generation. _Chainlink_ and _API3_ supply decentralized oracle infrastructure. _Kleros_ has operated a live jury-DAO since 2018, handling 1,000+ cases. Slashing mechanisms are operational in Ethereum proof-of-stake. The gap is not that nobody has the pieces but that nobody has tried to combine ZK-IoT with AI anomaly detection under DAO adjudication — the trust boundaries between these systems are undefined. TRL: 4; ZK-IoT proofs demonstrated on ESP32 microcontrollers at ~700ms.

_d/acc alignment._ Defensive scores highest at 5/5, reflecting the system's explicit design to detect and penalize fraud at multiple layers. Democratic and Decentralized both score 4/5, driven by the jury-DAO's human override capacity and the absence of any central arbiter.


_Links._
- #link("https://kleros.io/")[Kleros] — Decentralized jury-DAO for dispute resolution and arbitration on blockchain
- #link("https://www.risczero.com/")[RISC Zero] — Zero-knowledge virtual machine (zkVM) for generating ZK proofs of computation
- #link("https://chain.link/")[Chainlink] — Decentralized oracle network for secure off-chain data feeds
- #link("https://api3.org/")[API3] — First-party oracle network providing direct API connectivity to smart contracts
- #link("https://arxiv.org/html/2402.08322v2")[zk-IoT: Securing the Internet of Things with Zero-Knowledge Proofs on Blockchain Platforms] (2024)
- #link("https://arxiv.org/html/2401.03530v1")[Detecting Anomalies in Blockchain Transactions using Machine Learning Classifiers and Explainability Analysis] (2024)
- #link("https://www.mdpi.com/2076-3417/15/15/8330")[Anomaly Detection in Blockchain: A Systematic Review of Trends, Challenges, and Future Directions] (2025)
- Source: #link("https://worlds.existentialhope.com/world/hybrid-market/")[hybrid-market]
...
_Who's building toward this._ The Future of Humanity Institute and University of Oxford provided the academic home for Toby Ord's foundational theoretical work. The Effective Altruism community has explored small-scale applications through informal coordination on charitable donations across cause areas. No dedicated funding has been identified, and the concept sits at TRL 2—theorized and occasionally applied ad hoc, but without formal institutional infrastructure or governance mechanisms.

_d/acc alignment._ Moral trade scores highest on Democratic (5/5) and Decentralized (4/5) dimensions, reflecting its core design goal of enabling pluralistic coordination without imposing a dominant moral framework. Defensive and Differential scores are lower, as the concept addresses coordination rather than security or targeted acceleration.


_Links._
- #link("https://www.fhi.ox.ac.uk/")[Future of Humanity Institute, University of Oxford] — Academic research on moral trade theory; Toby Ord's institutional affiliation
- #link("https://www.effectivealtruism.org/")[Effective Altruism Community] — Informal coordination of moral trade discussions and small-scale implementations in cause prioritization
- #link("https://www.journals.uchicago.edu/doi/10.1086/682187")[Moral Trade] (2015)
- #link("https://forum.effectivealtruism.org/posts/L76qZhfvkediwXd6f/moral-public-goods-are-a-big-deal-for-whether-we-get-a-good")[Moral public goods are a big deal for whether we get a good future] (2025)
- #link("https://forum.effectivealtruism.org/posts/jvW6p5Hk2r4883tNT/moral-trade-proposal-with-95-100-surplus")[Moral Trade Proposal with 95-100% Surplus] (2024)
- Source: #link("https://www.existentialhope.com/podcasts/fin-moorhouse-why-we-need-to-aim-higher-than-survival")[fin-moorhouse-why-we-need-to-aim-higher-than-survival]
...
_Who's building toward this._ OpenBCI provides open-source hardware and software platforms with community adoption but without unified privacy or agency frameworks. AE Studio is developing agency-focused BCI tools including the Neurotech Development Kit, with neuroethical principles embedded in its approach. The Future of Privacy Forum is researching BCI-specific data protection standards, and the IEEE Standards Association published a 2024 Standards Roadmap for Neurotechnologies for Machine Interfacing covering sensing, feedback, and data management. No dedicated funding for a unified BCI-OS has been identified. TRL: 3.

_d/acc alignment._ BCI-OS scores highest on Defensive (5/5) and Democratic (4/5), reflecting its core architectural commitment to protecting user agency and neural data privacy, and its open-source governance model that distributes control away from any single manufacturer.


_Links._
- #link("https://openbci.com/")[OpenBCI] — Developing open-source BCI hardware and software platform with GUI, drivers, and developer tools
- #link("https://www.ae.studio/brain-computer-interface")[AE Studio] — Building BCI operating system with agency evaluation, neuroethical principles, and open-source software like Neurotech Development Kit
- #link("https://fpf.org/")[Future of Privacy Forum] — Researching BCI privacy standards, data protection recommendations, and ethical frameworks for neurotechnology
- #link("https://standards.ieee.org/")[IEEE Standards Association] — Developing Standards Roadmap for Neurotechnologies for Machine Interfacing covering sensing, feedback, data management, and performance
- #link("https://arxiv.org/abs/2201.07711")[Enhancing the Security & Privacy of Wearable Brain-Computer Interfaces] (2022)
- #link("https://standards.ieee.org/")[Standards Roadmap: Neurotechnologies for Machine Interfacing] (2024)
- #link("https://www.gao.gov/products/gao-25-106952")[Brain-Computer Interfaces: Applications, Challenges, and Policy Options] (2025)
...
_Links._
- #link("https://www.neurorightsfoundation.org")[Neurorights Foundation] — Advocacy and policy development for neural data privacy; supports state-level legislation
- #link("https://fpf.org")[Future of Privacy Forum (FPF)] — Research and guidance on BCI privacy frameworks and ethical considerations
- #link("https://www.columbia.edu")[Columbia University Neurotechnology Center] — Research on neurorights and neural data protection frameworks
- #link("https://journals.sagepub.com/doi/10.1177/20552076251326123")[Regulating neural data processing in the age of BCIs: Ethical concerns and legal approaches] (2025)
- #link("https://arxiv.org/abs/2209.09653")[A Framework for Preserving Privacy and Cybersecurity in Brain-Computer Interfacing Applications] (2022)
- #link("https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2024.1330439/full")[Chilean Supreme Court ruling on the protection of brain activity: neurorights, personal data protection, and neurodata] (2024)
- Source: #link("https://www.existentialhope.com/podcasts/mary-lou-jepsen-a-handheld-device-to-defeat-cancer")[mary-lou-jepsen-a-handheld-device-to-defeat-cancer]
...
_Who's building toward this._ The _Digital Public Goods Alliance_ (UN-endorsed) maintains a registry of 150+ open-source governance solutions and provides the closest structural analog to a coordinating body. The _Open Government Partnership_ promotes transparency and accountability frameworks across local and national governments. _OpenGov_ demonstrates commercial viability with AI-enabled tools for budgeting, permitting, and public engagement across 2,000+ US communities. The _Open Knowledge Foundation_ develops open-source standards and civic tech tools as a DPGA member. No dedicated funding for a unified consortium has been identified. TRL: 5 — field-tested components exist, but a true cooperative with distributed member control remains at prototype stage.
...
_Links._
- #link("https://digitalpublicgoods.xyz/")[Digital Public Goods Alliance (DPGA)] — UN-endorsed multi-stakeholder initiative facilitating discovery, development, and investment in open-source digital public goods for governance and SDGs
- #link("https://www.opengovpartnership.org/")[Open Government Partnership (OGP)] — Multi-stakeholder initiative promoting transparent, accountable AI governance in local and national governments
- #link("https://opengov.com/")[OpenGov] — AI-enabled software platform serving 2,000+ US communities with governance tools for budgeting, permitting, and public engagement
- #link("https://okfn.org/")[Open Knowledge Foundation (OKFN)] — Develops open-source standards and civic tech tools for governance; member of DPGA
- #link("https://www.opengovpartnership.org/documents/artificial-intelligence-and-open-government-local-perspectives-2025/")[Artificial Intelligence and Open Government: Local Perspectives] (2025)
- #link("https://www.opengovpartnership.org/stories/building-accountable-artificial-intelligence-in-government-a-practical-reform-agenda/")[Building Accountable Artificial Intelligence in Government: A Practical Reform Agenda] (2025)
- Source: #link("https://worlds.existentialhope.com/world/the-commons-cloud/")[the-commons-cloud]
...
_Links._
- #link("https://lina.community/projects/8e9dd1ac-2b08-4136-9680-d365de3de61b/")[bioregional.agency] — Implementing bioregional assembly practices in Austria; co-founded 2025 by Gordon Selbach and Jakob Travnik
- #link("https://www.regenerosity.world/bioregionalism-in-practice/")[Resilience.Earth] — Developing distributed decision-making tools and adaptive governance systems for bioregional communities
- #link("https://cascadiabioregion.org/")[Department of Bioregion / CascadiaNow!] — Advancing bioregional education and place-based regeneration strategies across Cascadia bioregion since 2005
- #link("https://cascadiabioregion.org/ozarks-bioregion")[Ozark Area Community Congress (OACC)] — Operating rotating consensus-based bioregional assembly since 1980 in Ozarks bioregion
- #link("https://compass.onlinelibrary.wiley.com/doi/full/10.1111/gec3.12722")[Where are you at? Re-engaging bioregional ideas and what they offer geography] (2023)
- #link("https://www.sciencedirect.com/science/article/pii/S2589811625000424")[Cyber-governance of the natural world: the implications of digital twins in environmental governance] (2025)
- #link("https://www.mdpi.com/2673-4591/120/1/32")[Digital Collaborative Mechanism of Ecological Governance Based on Digital Twin] (2026)
- Source: #link("https://worlds.existentialhope.com/world/the-commonsense-accord-collectively-stewarding-the-world-across-time-and-across-differences/")[the-commonsense-accord-collectively-stewarding-the-world-across-time-and-across-differences]
...
The _OpenID Foundation_ completed a real-world multi-region interoperability demonstration in May 2025. _W3C_ maintains Decentralized Identifiers (DIDs) and Verifiable Credentials standards. The _Trust Over IP Foundation_ is developing governance frameworks for decentralized digital trust, and _GovStack_ is assembling modular government building blocks covering identity, payments, and data exchange. Core identity standards are in production pilots across the EU, UK, Switzerland, Japan, and California, but the combined benefits-portability-plus-AI-crisis-coordination system remains at prototype stage. TRL: 4.
...
_Links._
- #link("https://openid.net/")[OpenID Foundation] — Developing OpenID for Verifiable Credentials standards and interoperability specifications for digital identity across jurisdictions
- #link("https://www.w3.org/")[W3C (World Wide Web Consortium)] — Maintaining Decentralized Identifiers (DIDs) and Verifiable Credentials standards for cross-jurisdictional identity portability
- #link("https://www.trustoverip.org/")[Trust Over IP Foundation] — Developing governance frameworks and architecture for decentralized digital trust infrastructure enabling interoperable identity systems
- #link("https://govstack.global/")[GovStack] — Building modular government digital infrastructure with interoperable building blocks for identity, payments, and data exchange across jurisdictions
- #link("https://arxiv.org/pdf/2601.14982")[Interoperable Architecture for Digital Identity Delegation for AI Agents with Blockchain Integration] (2026)
- #link("https://openid.net/openid-foundation-demonstrates-real-world-interoperabiity-of-new-digital-identity-standards/")[Real-World Interoperability Demonstration of New Standards] (2025)
- #link("https://www.arxiv.org/pdf/2510.16034")[Disaster Management in the Era of Agentic AI Systems: A Vision for Federated Crisis Response] (2025)
...
_Who's building toward this._ No organization is deliberately implementing CAIS as a unified design paradigm. The Future of Humanity Institute at the University of Oxford published Drexler's foundational 2019 technical report, _Reframing Superintelligence_, which remains the primary articulation of the framework. Individual narrow superhuman AIs—AlphaFold, chess engines—demonstrate isolated components, but without architectural enforcement of narrowness or a competitive service ecology. No dedicated funding has been identified. TRL: 2.
...
_Links._
- #link("https://www.fhi.ox.ac.uk")[Future of Humanity Institute (FHI), University of Oxford] — Published Drexler's foundational CAIS technical report; conducts research on AI safety and superintelligence
- #link("https://www.fhi.ox.ac.uk/publications/reframing-superintelligence-comprehensive-ai-services-as-general-intelligence-technical-report-2019-1-k-eric-drexler/")[Reframing Superintelligence: Comprehensive AI Services as General Intelligence] (2019)
- Source: #link("https://www.existentialhope.com/podcasts/nathan-labenz-what-are-the-best-case-scenarios-for-ai")[nathan-labenz-what-are-the-best-case-scenarios-for-ai]
...
_How it works._ Natural bodies granted legal personhood—rivers, lakes—become plaintiffs in lawsuits against polluters. A DAO pools capital from investors through tokenized litigation finance mechanisms, funding those cases and returning proceeds to investors when litigation succeeds. Investors profit when the lawsuits win. The lawsuits win when polluters lose. That's the whole trick.

_Who's building toward this._ The closest attempt was Aristata Capital, which explored climate litigation finance but stopped short of DAO governance or tokenization. Adjacent work is underway from several directions. _Ryval_ pioneered tokenized litigation finance via Initial Litigation Offerings on blockchain, completing its first ILO in October 2021. _LawCoin_ tokenizes litigation finance deals on Ethereum for institutional investors. _MediCoin_ has tokenized attorney fee interests specifically in environmental litigation, including PFAS cases. _ClientEarth_, the environmental law firm, has inspired litigation finance focused on climate cases through Aristata Capital. No known entity has combined environmental personhood, DAO governance, and tokenized litigation finance into a deployed system. TRL: 3. Funding: none identified for an integrated implementation.
...
_Links._
- #link("https://www.ryval.io")[Ryval] — Pioneering tokenized litigation finance via Initial Litigation Offerings (ILOs) on blockchain
- #link("https://www.lawcoin.io")[LawCoin] — Tokenizing litigation finance deals on Ethereum blockchain for institutional investors
- #link("https://www.medicoin.io")[MediCoin] — Tokenizing attorney fee interests in environmental litigation (PFAS cases)
- #link("https://www.clientearth.org")[ClientEarth] — Environmental law firm; inspired Aristata Capital's litigation finance focus on climate cases
- #link("https://arbitrationblog.kluwerarbitration.com/2022/03/16/litigation-finance-and-crypto-tokens-how-a-blockchain-startup-seeks-to-create-financing-marketplaces-for-disputes/")[Litigation Finance and Crypto Tokens: How a Blockchain Startup Seeks to Create Financing Marketplaces for Disputes] (2022)
- #link("https://scholars.unh.edu/unh_lr/vol17/iss2/13/")[Environmental Personhood and Standing for Nature: Examining the Colorado River Case] (2019)
- #link("https://theconversation.com/granting-legal-personhood-to-nature-is-a-growing-movement-can-it-stem-biodiversity-loss-227336")[Granting legal 'personhood' to nature is a growing movement] (2026)
- Source: #link("https://www.existentialhope.com/podcasts/trent-mcconaghy-from-starships-to-tokens-pioneering-futures")[trent-mcconaghy-from-starships-to-tokens-pioneering-futures]
...
_Who's building toward this._ Near Foundation is developing AI-powered delegates and the Pulse sentiment-tracking tool for DAO governance. SingularityNET operates a decentralized AI coordination platform using blockchain for service governance and privacy-preserving datasets. Aragon provides DAO infrastructure and tooling, while MakerDAO demonstrates on-chain token-based governance at meaningful scale. No dedicated funding for integrated human-AI hybrid governance DAOs has been identified. _TRL: 4_ — AI agents have been tested against 3,383 real proposals with 97% alignment to historical human decisions, and simulations show a 40% participation increase, but no production deployment at city or national scale exists.
...
_Links._
- #link("https://near.org")[Near Foundation] — Developing AI-powered delegates and governance tools (Pulse) for DAO voting and community sentiment tracking
- #link("https://singularitynet.io")[SingularityNET] — Decentralized AI governance platform using blockchain for AI service coordination and privacy-preserving datasets
- #link("https://aragon.org")[Aragon] — DAO governance infrastructure and tooling for decentralized organizations
- #link("https://makerdao.com")[MakerDAO] — Major DAO with on-chain governance and token-based voting mechanisms
- #link("https://arxiv.org/html/2511.08641v1")[QOC DAO - Stepwise Development Towards an AI Driven Decentralized Autonomous Organization] (2025)
- #link("https://arxiv.org/html/2510.21117v2")[DAO-AI: Evaluating Collective Decision-Making through Agentic AI in Decentralized Governance] (2025)
- #link("https://www.nature.com/articles/s41598-026-40180-8")[Democratic governance through DAO-based deliberation and voting for inclusive decision making in AI models] (2026)
- Source: #link("https://worlds.existentialhope.com/world/worldbuilding-course-worldbuilding-toolbox-world-entry-page-world-gallery-x-twitter-instagram-medium-bookmark-sadvipra-ai/")[worldbuilding-course-worldbuilding-toolbox-world-entry-page-world-gallery-x-twitter-instagram-medium-bookmark-sadvipra-ai]
...
_Who's building toward this._ The _International Joint Commission (IJC)_ has operated transboundary watershed governance between Canada and the US since 1909, with its International Watersheds Initiative (est. 1998) pioneering ecosystem-centered management with Indigenous participation. The _Mekong River Commission (MRC)_ coordinates four nations using integrated water resources management across the Mekong Basin. The _International Network of Basin Organizations (INBO)_ supports 120+ river basin organizations globally. The _Cascadia Department of Bioregion_ is developing bioregional governance frameworks across the Pacific Northwest, while _Resilience.Earth_ delivers bioregional governance training in Asia-Pacific. No dedicated funding for a unified treaty framework has been identified. TRL: 6—operational regional structures exist, but a binding global framework remains conceptual.
...
_Links._
- #link("https://ijc.org")[International Joint Commission (IJC)] — Manages transboundary watershed cooperation between Canada and US; operates International Watersheds Initiative with ecosystem-based governance around river basins
- #link("https://www.mrcmekong.org/")[Mekong River Commission (MRC)] — Coordinates sustainable management of Mekong River Basin across four countries; implements integrated water resources management based on watershed boundaries
- #link("https://www.inbo-news.org/")[International Network of Basin Organizations (INBO)] — Global network supporting 120+ international river basin organizations; facilitates knowledge exchange on watershed-based governance
- #link("https://cascadiabioregion.org/")[Cascadia Department of Bioregion] — Develops bioregional governance frameworks organized around watershed and ecological boundaries across Pacific Northwest
- #link("https://resilience.earth/")[Resilience.Earth] — Supports bioregional governance training and implementation in Asia-Pacific; develops climate-resilient ecosystem management frameworks
- #link("https://ijc.org/en/quarter-century-international-watersheds-initiative")[A Quarter Century of the International Watersheds Initiative] (2023)
- #link("https://ecolise.eu/wp-content/uploads/2025/03/Bioregional-Governance-Training-Guide.pdf")[Bioregional Governance for Climate-Resilient Ecosystems in Asia and the Pacific - Training Guide] (2024)
- #link("https://www.kosmosjournal.org/article/human-watershed-the-emerging-politics-of-bioregional-democracy/")[Human Watershed: The Emerging Politics of Bioregional Democracy] (2024)
- Source: #link("https://worlds.existentialhope.com/world/2035-rewild/")[2035-rewild]
...
_Who's building toward this._ Hugging Face hosts over 1,000 community-contributed translation models but has no governance layer for community decision-making over those models. Mozilla Common Voice crowdsources multilingual voice data but doesn't give contributors formal control over how it's used. Ocean Protocol provides decentralized data exchange with DAO governance and tokenized data assets. Aragon supplies DAO governance frameworks and is exploring AI-DAO integration. The missing link is connecting contributor governance to model development decisions. Overall TRL: 3.
...
_Links._
- #link("https://huggingface.co")[Hugging Face] — Hosts open-source translation models and community contributions; over 1,000 translation models available on Hub
- #link("https://oceanprotocol.com")[Ocean Protocol] — Decentralized data exchange with DAO governance; enables tokenized data assets and AI model training with community oversight
- #link("https://commonvoice.mozilla.org")[Mozilla Common Voice] — Crowdsources multilingual voice data for open-source speech recognition; community-driven data collection
- #link("https://aragon.org")[Aragon] — DAO governance framework and tools; explores AI-DAO integration for decentralized decision-making
- #link("https://arxiv.org/html/2511.08641")[QOC DAO - Stepwise Development Towards an AI Driven Decentralized Autonomous Organization] (2025)
- #link("https://www.sciencedirect.com/science/article/pii/S2096720923000416")[Governance of decentralized autonomous organizations that produce open source software] (2023)
- #link("https://blog.aragon.org/ai-daos-the-future-of-daos-powered-by-artificial-intelligence/")[The Future of DAOs is Powered by AI] (2023)
- Source: #link("https://worlds.existentialhope.com/world/la-langue-de-la-prvoyance/")[la-langue-de-la-prvoyance]
...
_Who's building toward this._ The _Murray-Darling Basin Authority_ (Australia) manages integrated water resources across a major watershed with Indigenous representation and multi-stakeholder governance. The _Susquehanna River Basin Commission_ and _Interstate Commission on the Potomac River Basin_ coordinate water management across multi-state jurisdictions in North America. The _Cascadia Department of Bioregion_ advocates for watershed-based political restructuring. New Zealand's Whanganui River, granted legal personhood in 2017, remains the clearest proof-of-concept for ecosystem rights integration. No dedicated funding was identified. TRL: 4 — operational governance structures exist at watershed scale, but full ecosystem representation and multi-generational impact assessment mechanisms remain largely theoretical.
...
_Links._
- #link("https://www.mdba.gov.au/")[Murray-Darling Basin Authority (MDBA)] — Principal government agency managing integrated water resources across Australian watershed; includes Indigenous representation and multi-stakeholder governance
- #link("https://www.srbc.gov/")[Susquehanna River Basin Commission (SRBC)] — Interstate agency coordinating water resource management across multi-state watershed in North America
- #link("https://www.potomacriver.org/")[Interstate Commission on the Potomac River Basin (ICPRB)] — Regional cooperation body for watershed governance bridging political boundaries across multiple states
- #link("https://cascadiabioregion.org/")[Cascadia Department of Bioregion] — Bioregional governance advocacy organization promoting watershed-based political and economic restructuring
- #link("https://www.kosmosjournal.org/article/human-watershed-the-emerging-politics-of-bioregional-democracy/")[Human Watershed: The Emerging Politics of Bioregional Democracy] (2022)
- #link("https://earth.org/bioregionalism/")[Bioregionalism: A Model for a Self-Sufficient and Democratic Economy] (2021)
- Source: #link("https://worlds.existentialhope.com/world/mycelial-democracy/")[mycelial-democracy]
...
_Who's building toward this._ The _Singapore Land Authority_ built Virtual Singapore, the first country-scale urban digital twin, operational since 2022 following a \$73M investment over 2012–2017. The _Alan Turing Institute_ is developing methodology for scalable digital twin ecosystems and national digital twin infrastructure. _Northeastern University's Boston Area Research Initiative (BARI)_ is building Fora.ai, a participatory modeling platform for community-led digital twins in green infrastructure planning. _The Nature Conservancy and Esri_ are developing environmental digital twins for ecosystem monitoring, including the Point Conception project. TRL sits at 5: urban digital twin components are mature, but participatory governance integrated with community data sovereignty at scale remains in prototype phase.
...
_Links._
- #link("https://www.esri.com/about/newsroom/blog/open-science-environmental-digital-twin")[The Nature Conservancy & Esri] — Creating environmental digital twins for ecosystem monitoring and conservation (Point Conception project)
- #link("https://www.turing.ac.uk/research/research-projects/ecosystems-digital-twins")[Alan Turing Institute] — Developing methodology for scalable digital twin ecosystems and National Digital Twin infrastructure
- #link("https://www.northeastern.edu/")[Northeastern University Boston Area Research Initiative (BARI)] — Building Fora.ai participatory modeling platform for community-led digital twins in green infrastructure planning
- #link("https://www.sla.gov.sg/")[Singapore Land Authority (SLA)] — Developing Virtual Singapore, the first country-scale digital twin for urban planning and disaster management
- #link("https://journals.sagepub.com/doi/10.1177/23998083251323671")[Enhancing digital twin technology with community-led, science-driven participatory modeling: A case in green infrastructure planning] (2025)
- #link("https://journals.sagepub.com/doi/full/10.1177/03063127241236809")[Digital twins and the digital logics of biodiversity] (2024)
- #link("https://www.researchgate.net/publication/359184358_City_Digital_Twin_Concepts_A_Vision_for_Community_Participation")[City Digital Twin Concepts: A Vision for Community Participation] (2022)
- Source: #link("https://worlds.existentialhope.com/world/the-commonsense-accord-collectively-stewarding-the-world-across-time-and-across-differences/")[the-commonsense-accord-collectively-stewarding-the-world-across-time-and-across-differences]
...
The Montreal AI Ethics Institute has developed research and design frameworks for fiduciary AI systems. Consumer Reports Innovation is exploring personal AI agents operating under fiduciary duty principles. The Alignment Research Center contributes relevant user-centric alignment research. No dedicated external funding has been documented. _TRL 3_ — published design methodologies and legal frameworks exist, but no commercial deployment has occurred.
...
_Links._
- #link("https://montrealethics.ai/")[Montreal AI Ethics Institute] — Research and design framework for Fiduciary AI systems
- #link("https://innovation.consumerreports.org/")[Consumer Reports Innovation] — Exploring personal AI agents with fiduciary duty frameworks
- #link("https://alignment.anthropic.com/")[Alignment Research Center] — AI alignment research including user-centric AI systems
- #link("https://dl.acm.org/doi/fullHtml/10.1145/3617694.3623230")[Designing Fiduciary Artificial Intelligence] (2023)
- #link("https://www.bu.edu/law/files/2023/09/Fiduciary-paper.pdf")[Fiduciary Principles in AI: Utilizing the Duty of Loyalty] (2023)
- #link("https://innovation.consumerreports.org/empowering-consumers-with-personal-ai-agents-legal-foundations-and-design-considerations/")[Empowering Consumers with Personal AI Agents: Legal Foundations and Design Considerations] (2025)
- Source: #link("https://www.existentialhope.com/podcasts/anthony-aguirre-anna-yelizarova-on-worldbuilding")[anthony-aguirre-anna-yelizarova-on-worldbuilding]
...
_Who's building toward this._ The _UN Global Dialogue on AI Governance_ (launched August 2025) provides the most operational foundation, offering an inclusive state-and-stakeholder platform. _AI4Deliberation_ (Horizon Europe, €2,999,500) is building AI-enabled deliberative toolkits for governments. _Connected by Data_ is researching independent global assembly designs for AI governance. _AI & Democracy Foundation_ focuses on deliberative processes for AI alignment. _Metagov_ develops digital self-governance infrastructure. TRL sits at 4: pilots are proven, but no unified global coordination architecture exists yet.
...
_Links._
- #link("https://www.un.org/global-dialogue-ai-governance/en")[Global Dialogue on AI Governance (UN)] — UN platform for inclusive global stakeholder discussions on AI governance, established August 2025
- #link("https://cordis.europa.eu/project/id/101178806")[AI4Deliberation (Horizon Europe Project)] — Building AI-enabled deliberative processes and toolkit for governments to design and institutionalize mass citizen deliberations
- #link("https://aidemocracyfoundation.org/")[AI & Democracy Foundation] — Driving design and adoption of democratic systems for AI alignment and governance through deliberative processes
- #link("https://connectedbydata.org/resources/global-deliberation-ai")[Connected by Data] — Researching global citizen deliberation options for AI governance, including independent global assembly designs
- #link("https://metagov.org/")[Metagov] — Nonprofit research lab facilitating self-governance through technology and digital deliberation systems
- #link("https://arxiv.org/pdf/2503.04766")[Global AI Governance: Where the Challenge is the Solution] (2025)
- #link("https://connectedbydata.org/resources/global-deliberation-ai")[Global Citizen Deliberation on Artificial Intelligence: Options and design considerations] (2024)
- #link("https://www.un.org/sites/un2.un.org/files/governing_ai_for_humanity_final_report_en.pdf")[Governing AI for Humanity (UN High-Level Advisory Body Final Report)] (2024)
...
_Who's building toward this._ The Coalition for Content Provenance and Authenticity (C2PA) released its open technical standard in 2022, with adoption now spanning camera makers, news outlets, and platforms. The Content Authenticity Initiative (CAI) develops open-source tooling within that coalition. X's Community Notes operates crowdsourced fact-checking at scale with 133,000+ contributors. Numbers Protocol integrates C2PA provenance data with blockchain for immutable asset tracking. No dedicated funding for a unified epistemic stack has been identified. TRL: 4—components exist in isolation; end-to-end integration from raw sensor data through inference to published claims with per-node trust scoring remains unbuilt.
...
_Links._
- #link("https://c2pa.org/")[Coalition for Content Provenance and Authenticity (C2PA)] — Developing open technical standards for digital content provenance and authenticity via Content Credentials
- #link("https://contentauthenticity.org/")[Content Authenticity Initiative (CAI)] — Creating open-source tools and systems for content provenance, part of C2PA coalition
- #link("https://communitynotes.x.com/")[X (Twitter) Community Notes] — Operating crowdsourced fact-checking and context-provision system with public data and algorithms
- #link("https://captureapp.xyz/")[Numbers Protocol / Capture] — Integrating C2PA provenance data with blockchain for immutable digital asset provenance tracking
- #link("https://www.oliversourbut.net/p/a-full-epistemic-stack")[A Full Epistemic Stack: Knowledge Commons for the 21st Century] (2025)
- #link("https://arxiv.org/abs/2509.13365")[The Provenance Problem: LLMs and the Breakdown of Citation Norms] (2025)
- #link("https://arxiv.org/html/2603.02960")[Architecting Trust in Artificial Epistemic Agents] (2025)
- Source: #link("https://www.existentialhope.com/podcasts/anthony-aguirre-tools-or-agents-choosing-our-ai-future")[anthony-aguirre-tools-or-agents-choosing-our-ai-future]
...
_Spotlight:_
- _AI cryptographic oracle with zero-knowledge IoT auditing and jury-DAO_ — A fraud-resistance layer combining zero-knowledge proofs from IoT sensor data, AI anomaly detection, stake-slashing penalties, and a decentralized human jury for retroactive balance correction. (Bottleneck: Coordination)
- _Moral Trade_ — A mechanism by which people or groups with different moral priorities swap concessions so that each gets more of what they care about than unilateral action would yield. (Bottleneck: Coordination)
- _Comprehensive AI Services (Drexler)_ — An architecture of many narrow, domain-limited superhuman AIs that interact competitively rather than a single general superintelligence, achieving safety through structural narrowness. (Bottleneck: Coordination)
- _Wisdom DAO_ — A decentralized autonomous organization where human citizens and AI systems jointly propose, deliberate, and vote on governance policy using weighted voting and blockchain transparency. (Bottleneck: Regulation)
...
_Spotlight:_
- _Tokenized neural data sharing with selective disclosure_ — A privacy architecture for BCI systems in which neural data is tokenized so users can selectively disclose specific streams of thought or brain state while retaining others as private. (Bottleneck: Regulation)
- _Interbeing Forum_ — A rotating bioregional assembly that grants formal representation to ecosystems and future generations through human guardians advised by digital twin data. (Bottleneck: Regulation)
- _Attack Dog DAO for Climate_ — A DAO that funds and coordinates environmental litigation on behalf of legally-recognized natural entities, financed through tokenized litigation investment. (Bottleneck: Regulation)
- _Accord of Watersheds_ — An international treaty framework that organizes political cooperation around watershed and bioregional boundaries rather than national borders. (Bottleneck: Regulation)
- _Watershed Parliaments_ — Bioregional governance bodies organized around watershed boundaries rather than political borders, incorporating ecological feedback into formal decision-making. (Bottleneck: Regulation)
- _Loyal AI Assistance (Fiduciary AI Assistance)_ — A personal AI system explicitly designed to be loyal to the individual user's goals rather than to platform or advertiser interests, contrasted with current assistants like Siri or Alexa. (Bottleneck: Regulation)
...
_Spotlight:_
- _Community-Governed AI Mesh Systems_ — Decentralized AI networks trained on locally governed data and stewarded by community trust circles rather than centralized corporate or state actors. (Bottleneck: Coordination)
- _Universal AI Learning UnCommons (UALU)_ — A federated governance institution that develops, maintains, and audits AI education tools through multi-stakeholder councils including elders, learners, and ethicists. (Bottleneck: Coordination)
- _BCI Operating System (BCI-OS)_ — An open-source operating system layer for brain-computer interfaces that embeds agency evaluation, AI model compatibility, and privacy standards as core OS-level features. (Bottleneck: Coordination)
- _Civic Systems Co-Op_ — A global open-source consortium that develops and maintains ethical AI tools for municipal and community governance. (Bottleneck: Coordination)
- _Interoperable Governance Protocol Stack_ — A shared technical and governance protocol layer that allows citizens to port digital identities, benefits, and credentials across distinct federated city-state systems, and enables AI systems across those jurisdictions to align resource allocation and crisis modeling. (Bottleneck: Regulation)
- _DAO-governed open innovation platform for TLM documentation and training data_ — A DAO-based governance structure that mandates open-source documentation and community-sourced feedback loops for translation model development and adaptation. (Bottleneck: Coordination)
- _Digital Twins for Communities and Ecosystems_ — Real-time digital models of communities and ecosystems that enable participatory future simulation with locally-owned data. (Bottleneck: Coordination)
- _The Global Deliberation Coordinator_ — A platform institution designed to coordinate global deliberative processes and collective decision-making specifically around AI governance. (Bottleneck: Coordination)
- _Epistemic stack_ — A citation and provenance system for all information—from newspaper articles to social media claims—that lets users trace any assertion back to its raw data sources, with trust scores based on historical accuracy of each link in the chain. (Bottleneck: Coordination)
